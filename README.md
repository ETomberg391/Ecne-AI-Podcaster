...
*   Part 2 is broken down and remade into podcast_builder.py script. Tested working with some tweaks for final output and archived folder to seperate some logic. 
...
Next Steps:
*    WebGUI the Part 2 and move away from the Pygame GUI.
*    Combine WebGUIs for both parts and implement a proper fontend user control panel. Something to include a general settings page, exploring finished scripts and videos, access to the part 1/2, AND an all-in-one flow process option for parts 1+2.
